...
--
-- Host: localhost:3306
-- Tempo de geração: 03/05/2022 às 08:33
...
--
-- Fazendo dump de dados para tabela `consultorio`
--

INSERT INTO `consultorio` (`id`, `paciente`, `idade`, `diagnostico`) VALUES
(11, 'rafael', 17, '20'),
(12, 'diandra', 19, '7');
...
-- Banco de dados: `ana`
--
CREATE DATABASE IF NOT EXISTS `ana` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ana`;
...
CREATE TABLE `alunos` (
  ...
  `curso` set('','Info','Meca','Edif') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('alunos', '[{\"db\":\"alunos\",\"table\":\"consultorio\"},{\"db\":\"alunos\",\"table\":\"usuario\"},{\"db\":\"alunos\",\"table\":\"Rafael_T\"},{\"db\":\"ana\",\"table\":\"alunos\"},{\"db\":\"alunos\",\"table\":\"clientes\"}]');
